                    ...
                    <div className="space-y-2">
                      <div className="border-2 border-green-500 bg-green-50 p-3 rounded">
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <p className="font-semibold text-sm">Vehicle #1</p>
                      ...
                      <div className="border border-gray-300 bg-white p-3 rounded">
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <p className="font-semibold text-sm">Vehicle #2</p>
                ...
                <div className="border-2 border-gray-300 rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 space-y-3">
                    <div className="bg-gray-100 p-2 rounded text-center">
                      <p className="text-xs text-gray-600">14-Seater Taxi Layout</p>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
                <div className="bg-gray-50 p-3 rounded border">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• name</li>
                    <li>• email</li>
                    <li>• user_type (passenger/driver/admin)</li>
                    <li>• created_at</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-3 rounded border">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• arrival_time</li>
                    <li>• status (ready/in_transit/completed)</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-3 rounded border">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• status (pending/success/failed)</li>
                    <li>• created_at</li>
                  </ul>
                </div>
              </div>
